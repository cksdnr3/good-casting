                                            ...
                                            <div className="col-md-6">
                                                <div className="media align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="font-size-3 text-gray line-height-2">{hire.producer.agency}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-6 text-right pt-7 pt-md-0 mt-md-n1">
                                                <div className="media justify-content-md-end">
                                                    <p className="font-size-4 text-gray mb-0">마감날짜 : {hire.deadline.slice(0, 10)}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="job-details-content pt-8 pl-sm-9 pl-6 pr-sm-9 pr-6 pb-10 light-mode-texts">
                                        <div className="row">
                                            <div className="col-xl-11 col-md-12 pr-xxl-9 pr-xl-10 pr-lg-20">
                                                <div className="">
                                                    <p className="mb-4 font-size-4 text-gray">모집내용</p>
                                                    <p className="font-size-4 text-black-2 mb-7">{hire.contents}</p>
                                                </div>
                                                <div className="">
                                                    <span className="font-size-4 font-weight-semibold text-black-2 mb-7">회사정보</span>
